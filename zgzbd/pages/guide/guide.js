...
Page({
  ...
  onLoad: function (options) {
    ...
    userApi.xcx_login_new(function (){
      userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/recite_params", {}, function (res) {
        that.setData({
  ...
  chooseSubject: function (e) {
    ...
    setTimeout(function () {
      ...
      userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/recite_identify", { level: that.data.select_level, subject: select_subject }, function (res) {
