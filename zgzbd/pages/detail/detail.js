...
Page({
    ...
    if (t == 0){
      ...
      if (that.data.questions[cur]) {
        ...
        if (that.data.questions[cur].loaded_comments == 0) {
          userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/article_comments", { article_id: that.data.questions[cur].article_id, inf_id: 0 }, function (res) {
      ...
      if (that.data.dones[cur]) {
        ...
        if (that.data.dones[cur].loaded_comments == 0) {
          userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/article_comments", { article_id: that.data.dones[cur].article_id, inf_id: 0 }, function (res) {
            if (res.data.data && res.data.data.length) {
  ...
  onLoad: function (options) {
    ...
    userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/recite_taks_questions", { taskid: that.variables.taskid }, function (res) {
      if (res.data.data.dones && res.data.data.dones.length){
        ...
        userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/recite_questions", { taskid: that.variables.taskid,ids: ids1.join(',') }, function (res1) {
          let qus = [];
          let loop = 0;
      ...
      if (res.data.data.ids && res.data.data.ids.length) {
        ...
        userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/recite_questions", { taskid: that.variables.taskid,ids: ids2.join(',') }, function (res2) {
          let qus = [];
          let loop = 0;
  ...
  onLower: function (e) {
    ...
    if (t == 0) {
      ...
      if (that.data.questions[cur]) {
        ...
        userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/article_comments", { article_id: that.data.questions[cur].article_id, inf_id: inf_id }, function (res) {
          if (res.data.data && res.data.data.length) {
            if (!comments){
              comments = [];
            }
      ...
      if (that.data.dones[cur]) {
        ...
        userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/article_comments", { article_id: that.data.dones[cur].article_id, inf_id: inf_id }, function (res) {
          if (res.data.data && res.data.data.length) {
            if (!comments) {
              comments = [];
            }
  ...
  remember: function (e) {
    ...
    if (t == 0){
      if (that.data.questions[cur]) {
        ...
        //调用后台的成功
        userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/recite_question_ok", { taskid: that.variables.taskid, id: questionid }, function (res1) {
        });
  ...
  onDianzanEvent: function (e) {
    ...
    if (like > 0) {
      userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/article_like_del", { comment_id: cid }, function (res) {
        that.setData({
          [isliked_text]: 0,
          [likes_text]: --likes
        });
      ...
      userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/article_like_add", { comment_id: cid }, function (res) {
        that.setData({
          [isliked_text]: 1,
          [likes_text]: ++likes
        });
  ...
  collect: function (e) {
    ...
    userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/fav_questions", {
      id: id
    }, function (res) {
      wx.showToast({
        title: res.data.msg,
  ...
  canclefav: function (e) {
    ...
    userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/cancel_fav_question", {
      id: id
    }, function (res) {
      wx.showToast({
        title: res.data.msg,
