...
Page({
  ...
  initTasks:function(){
    ...
    let interval = setInterval(() => {
      if (app.globalData.userToken != "") { // 判断已经有token了
        ...
        that.is_loaded = 1;
        userApi.requestAppApi_GET(app.globalData.mainDomain + "XcxApi/recite_tasks", { level: app.globalData.level > 0 ? app.globalData.level : 1, subject: app.globalData.subject > 0 ? app.globalData.subject : 11 }, function (res) {
        ...
        userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/query_score_bomb", { scene: app.globalData.scene }, function (res) {
        ...
        userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/banner", {}, function (res) {
        ...
        userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/bomb_box", { scene: app.globalData.scene_type }, function (res) {
        ...
        userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/recite_inter_tasks", {}, function (res) {
          console.log(res.data);
          that.setData({
  ...
  onLoad: function (options) {
    ...
    if (options.scene && options.scene != "") {
      ...
      userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/channel", {
        channel: channel
      }, function (res) {
      });
    }
  ...
  getQuestionId: function (questionid,callback){
    ...
    userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/recite_questions", { ids: questionid, taskid: that.data.last_taskid }, function (res1) {
  ...
  completeQuestionId:function(questionid,callback){
    ...
    if (ind >= 0){
      ...
      //调用后台的成功
      userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/recite_question_ok", { taskid: that.last_taskid, id: questionid}, function (res1) {
      });
