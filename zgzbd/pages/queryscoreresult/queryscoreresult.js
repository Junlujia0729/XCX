...
Page({
  ...
  onLoad: function (options) {
    ...
    userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/getChafenToken", {
      ...
      chafenopenid = res.data.data.openid;
      chafentoken = res.data.data.token;
      let url = app.globalData.mainQueryDomain + "ApiJiucuo/xcx_chafen_query?openid=" + chafenopenid + "&token=" + chafentoken;
      ...
      //上报formid
      userApi.requestAppApi_POST(app.globalData.mainQueryDomain + "ApiNlpgbg/xcx_formidByUid", { formid: options.formid, openid: chafenopenid, unionid: app.globalData.unionId, token: chafentoken }, function (res) {
        console.log('formID')
      });
    });
