...
Page({
  ...
  onLoad: function (options) {
    ...
    if (options.group) {
      that.setData({ ifgroup: options.group, groupid: options.groupid});
        ...
        userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/group_order", {
          ...
          if (items.handout > 0) {
            userApi.requestAppApi_GET(app.globalData.mainDomain + "XcxApi/defaultAddress", {
            }, function (res1) {
        ...
        userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/order", {
          classid: that.data.classid,
        }, function (res) {
          console.log(res.data.data);
          var items = res.data.data;
  ...
  confirmOrder:function(e){
    ...
    if (that.data.ifgroup == 0){
      //正常购课支付
      userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/wxpay", {
        classid: that.data.classid,
      ...
      userApi.requestAppApi_POST(app.globalData.mainDomain + "XcxApi/group_wxpay", {
        classid: that.data.classid,
        addressid: that.data.address.id ? that.data.address.id : 0,
        discountid: that.data.payinfo.discount.length ? that.data.payinfo.discount[0].id : 0,
        examlevel: that.data.selectlevel,
